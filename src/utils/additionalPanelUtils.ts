  ...
  switch (direction) {
    ...
    case "Left":
      ...
      const bottomPanel: LatLngTuple[] = [
        [initialPanel[0][0], initialPanel[0][1] - (panelHeight + spacing)],
        [initialPanel[1][0], initialPanel[1][1] - (panelHeight + spacing)],
        [initialPanel[2][0], initialPanel[2][1] - (panelHeight + spacing)],
        [initialPanel[3][0], initialPanel[3][1] - (panelHeight + spacing)],
      ];
      return bottomPanel;
    ...
    case "Top":
      ...
      const leftPanel: LatLngTuple[] = [
        [initialPanel[0][0] + (panelWidth + topSpacing), initialPanel[0][1]],
        [initialPanel[1][0] + (panelWidth + topSpacing), initialPanel[1][1]],
        [initialPanel[2][0] + (panelWidth + topSpacing), initialPanel[2][1]],
        [initialPanel[3][0] + (panelWidth + topSpacing), initialPanel[3][1]],
      ];
      return leftPanel;
